                                ...
                                <tbody>
                                    ...
                                    while ($row = mysqli_fetch_assoc($res)) { ?>
                                        <tr>
                                            ...
                                            echo "<button type='button' class='btn btn-info' style='color: white; font-weight: bold;'><a href='manage_size.php?id=" . $row['id'] . "' style='color: inherit; text-decoration: none;'>Edit</a></button>&nbsp";
