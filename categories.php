						...
						<div class="htc__grid__top">
							<div class="htc__select__option">
								<select class="ht__select"
									...
									<option value="price_low" <?php echo $price_low_selected ?>>Sort by price low to
										high
									</option>
									<option value="price_high" <?php echo $price_high_selected ?>>Sort by price high to
										low
									</option>
											...
											<div class="category">
												...
												<div class="fr__product__inner">
													...
													<ul class="fr__pro__prize">
														<li class="old__prize" style="text-decoration:line-through; font-weight:bold;"><?php echo '&#x20B9;'.$list['mrp'] ?></li>
