                    ...
                    <div class="col-xs-12">
                        <form id="login-form" method="post">
                            <div class="single-contact-form">
                                <div class="contact-box name">
                                    <input type="text" name="login_email" id="login_email" placeholder="Your Email*"
                                        style="width:100%" class="borderrr">
                            ...
                            <div class="single-contact-form">
                                <div class="contact-box name">
                                    <input type="password" name="login_password" id="login_password"
                                        placeholder="Your Password*" style="width:100%" class="borderrr">
                            ...
                            <div class="contact-btn">
                                <button type="button" class="fv-btn borderrr" onclick="user_login()">Login</button>
                ...
                <div class="contact-form-wrap mt--60">
                    ...
                    <div class="col-xs-12">
                        <form id="register-form" method="post">
                            <div class="single-contact-form">
                                <div class="contact-box name">
                                    <input type="text" name="name" id="name" placeholder="Your Name*" class="borderrr"
                                        style="width:100%">
                                </div>
                            ...
                            <div class="single-contact-form">
                                <div class="contact-box name">
                                    <input type="text" name="email" id="email" placeholder="Your Email*"
                                        style="width:45%" class="borderrr">
                                    <button type="button" class="fv-btn email_sent_otp"
                                        style="margin-top:5px; border-radius:50px;" onclick="email_sent_otp()">Send
                                        OTP</button>
                                    <input type="text" id="email_otp" placeholder="OTP" class="email_verify_otp"
                                        style="width:45%">
                                    <button type="button" class="fv-btn email_verify_otp"
                                        style="margin-top:5px;border-radius:50px;" onclick="email_verify_otp()">Verify
                                        OTP</button>
                                    <span id="email_otp_result"
                                        style=" margin-top: 20px; color:lightseagreen ;font-size:large;font-weight:600;"></span>
                            ...
                            <div class="single-contact-form">
                                <div class="contact-box name ">
                                    <input type="text" name="mobile" id="mobile" placeholder="Your Mobile*"
                                        class="borderrr" style="width:45%">
                                    <button type="button" class="fv-btn mobile_sent_otp borderrr"
                                        style="margin-top:5px; border-radius:50px;" onclick="mobile_sent_otp()">Send
                                        OTP</button>
                                    <input type="text" id="mobile_otp" placeholder="OTP"
                                        class="mobile_verify_otp borderrr" style="width:45%">
                                    <button type="button" class="fv-btn mobile_verify_otp borderrr"
                                        style="margin-top:5px; border-radius:50px;" onclick="mobile_verify_otp()">Verify
                                        OTP</button>
                                    <span id="mobile_otp_result"
                                        style=" margin-top: 20px; color:lightseagreen ;font-size:large;font-weight:600;"></span>
                            ...
                            <div class="contact-btn">
                                <button type="button" class="fv-btn borderrr"
