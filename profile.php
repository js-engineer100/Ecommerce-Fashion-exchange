                            ...
                            <div class="single-contact-form">
                                <div class="contact-box name">
                                    <input type="text" name="name" id="name" placeholder="Your Name*" style="width:100%"
                                        value="<?php echo $_SESSION['USER_NAME'] ?>" class="borderrr">
                                </div>
                                <span class="field_error" id="name_error"></span>
                            </div>

                            <div class="contact-btn">
                                <button type="button" class="fv-btn borderrr" onclick="update_profile()"
                        ...
                        <div class="col-xs-12">
                            <form method="post" id="frmPassword">
                                ...
                                <div class="single-contact-form">
                                    ...
                                    <div class="contact-box name">
                                        <input type="password" name="new_password" id="new_password" style="width:100%" class="borderrr">
                                    </div>
                                ...
                                <div class="contact-btn">
                                    <button type="button" class="fv-btn borderrr" onclick="update_password()"
                                        id="btn_update_password">Update</button>
