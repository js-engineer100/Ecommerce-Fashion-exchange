                                ...
                                while ($row = mysqli_fetch_assoc($res)) {
                                    ...
                                    <tr>
                                        <td class="product-thumbnail">
                                            <a href="#"><img src="<?php echo PRODUCT_IMAGE_SITE_PATH . $row['image']; ?>"
                                        ...
                                        <td class="product-action">
                                            <a href="wishlist.php?wishlist_id=<?php echo $row['id']; ?>"><i
                                                    class="icon-trash icons" style="font-size:xx-large;"></i></a>
                                            <!-- <div class="buttons-cart checkout--btn"> -->
                                            <a href="javascript:void(0)"
                                                onclick="manage_cart('<?php echo $row['pid']; ?>', 'add')">
